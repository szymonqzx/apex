...
REQUIRED_Y = [
    "CONFIG_CPU_FREQ",
    "CONFIG_CPU_FREQ_DEFAULT_GOV_SCHEDHORIZON",
    "CONFIG_CPU_FREQ_GOV_SCHEDUTIL",
    "CONFIG_CPU_FREQ_GOV_SCHEDHORIZON",
...
FEATURE_GROUPS = {
    ...
    "apex": ["CONFIG_APEX_SYSFS"],
    "baseband": ["CONFIG_BBG", "CONFIG_BBG_BLOCK_BOOT", "CONFIG_BBG_BLOCK_RECOVERY"],
    "tuning": ["CONFIG_HZ_300", "CONFIG_MQ_IOSCHED_SSG", "CONFIG_MQ_SSG_DEFAULT",
               "CONFIG_CPU_FREQ_DEFAULT_GOV_SCHEDHORIZON", "CONFIG_CC_OPTIMIZE_FOR_PERFORMANCE_O3",
               "CONFIG_DAMON_RECLAIM", "CONFIG_F2FS_UNFAIR_RWSEM", "CONFIG_KPROFILES"],
